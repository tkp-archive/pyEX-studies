...
# -*- coding: utf-8 -*-
#
# pyEX-caching documentation build configuration file, created by
...
# built documents.
#
_version_py = os.path.join('..', '..', 'pyEX', 'caching', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'pyEX-cachingdoc'
...
latex_documents = [
    (master_doc, 'pyEX-caching.tex', 'pyEX-caching Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyEX-caching', 'pyEX-caching Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyEX-caching', 'pyEX-caching Documentation',
     author, 'pyEX-caching', 'One line description of project.',
     'Miscellaneous'),
]
